...
::: {.notes}
https://docs.google.com/spreadsheets/d/1lTjv7EYyGPKzjekBJ29xRqCUxhrMT0nuO4gsW6qEb9s/edit?gid=1882477504#gid=1882477504
:::
...
- Rachel Udow will share her experience in R in 3 Months
...
:::{.center-slide}
[![](assets/colorado-report-two-pages.png)](https://publichealth.jhu.edu/ivac/resources/reports/monitoring-childhood-immunization-at-the-state-level)
:::
...
::: {.column width="50%"}
![](assets/rin3-discord.png)
:::

::: {.column width="50%"}
We have a Discord server to learn together, share accomplishments, frustrations, and pet pictures!
:::
::::
...
*Only happen during the 3 months, but you'll have access to them forever.*

- Course materials and Discord server  
